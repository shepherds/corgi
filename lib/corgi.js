...
function Corgi(systems, storage, options) {
...
require('util').inherits(Corgi, events.EventEmitter);

Corgi.prototype.ping = function (params, callback){
...
/*-----------------------
 Starts the service
------------------------*/
Corgi.prototype.start = function (){
 var self = this;
 ...
 console.log('corgi monitor started.');
};
