...
define('tpl!templates/login.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="tr">\n\t<h3 style="margin-top: 30px;">Welcome to Corgi</h3>\n\t<br>\n\t<span class="text-muted">PLEASE LOG IN BELOW</span>\n\t<form id="login-form" action="/login" method="post" class="form">\n\t\t<div class="form-group">\n\t\t\t<input type="text" class="form-control" id="username" name="username" placeholder="Username">\n\t\t</div>\n\t\t<div class="form-group">\n\t\t\t<input type="password" class="form-control" id="password" name="password" placeholder="Password">\n\t\t</div>\n\t\t<div class="form-group" style="text-align: left;">\n\t\t\t<a href="#" style="border-bottom: 1px dashed #000;">Forgot Password?</a>\n\t\t\t<button type="submit" id="login-btn" class="btn btn-primary btn-xs pull-right">Log In</button>\n\t\t</div>\n\t</form>\n</div> <!-- /#login -->\n';
...
/*global define*/
define(
  'views/Login',['marionette','vent','tpl!templates/login.tmpl'],
...
define('tpl!templates/wizard.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="tr">\n\t<h3 style="margin-top: 30px;">Setup Information</h3>\n\t<br>\n\t<span class="text-muted">Mongo Database</span>\n\t<form id="setup-form" class="form">\n\t\t<div class="form-group">\n\t\t\t<label>Server IP Address</label>\n\t\t\t<input type="text" class="form-control" id="ipaddr" name="ipaddr">\n\t\t</div>\n\t\t<div class="form-group">\n\t\t\t<label></label>\n\t\t\t<input type="password" class="form-control" id="password" name="password" placeholder="Password">\n\t\t</div>\n\t\t<div class="form-group" style="text-align: left;">\n\t\t\t<button type="button" id="back-btn" class="btn btn-primary btn-xs pull-left">Back</button>\t\n\t\t\t<button type="button" id="next-btn" class="btn btn-primary btn-xs pull-right">Next</button>\n\t\t</div>\n\t</form>\n</div>\n';
...
/*global define*/
define(
  'views/Wizard',['marionette','vent','tpl!templates/wizard.tmpl'],
  function (Marionette, vent, tmpl) {
    'use strict';
...
define('tpl!templates/main/home.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<nav class="navbar navbar-default" role="navigation">\n  <!-- Brand and toggle get grouped for better mobile display -->\n  <div class="navbar-header">\n    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">\n      <span class="sr-only">Toggle navigation</span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n      <span class="icon-bar"></span>\n    </button>\n    <a class="navbar-brand" href="#">Corgi</a>\n  </div>\n\n  <!-- Collect the nav links, forms, and other content for toggling -->\n  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\n    <ul class="nav navbar-nav navbar-right">\n      <li><a id="admin" href="#"><i class="fa fa-lock"></i> Admin</a></li>\n      <li><a id="profile" href="#"><i class="fa fa-user"></i> Profile</a></li>\n      <li><a id="help" href="#"><i class="fa fa-question"></i> Help</a></li>\n      <li><a id="logout" href="#"><i class="fa fa-power-off"></i> Logout</a></li>\n    </ul>\n  </div><!-- /.navbar-collapse -->\n</nav>\n\n<div id="content">\n\n</div>';
...
/*global define*/
define(
  'views/main/Home',['marionette','vent','tpl!templates/main/home.tmpl'],
...
define('tpl!templates/main/admin.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="container">\n\t<ul class="nav nav-tabs">\n\t\t<li class="active"><a href="#users">Users</a></li>\n\t\t<li><a href="#">Groups</a></li>\n\t\t<li><a href="#">Systems</a></li>\n\t\t<li><a href="#">Widgets</a></li>\n\t\t<li><a href="#">Package Manager</a></li>\n\t</ul>\n\t<div class="tab-content">\n\t\t<div id="users" class="tab-pane fade in active">\n\t\t\t<table class="table table-hover table-striped" style="background-color: #3c3c3c;">\n\t\t\t\t<thead>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th>Username</th>\n\t\t\t\t\t\t<th>Email</th>\n\t\t\t\t\t\t<th>&nbsp;</th>\n\t\t\t\t\t</tr>\n\t\t\t\t</thead>\n\t\t\t\t<tbody>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<td>Svjard</td>\n\t\t\t\t\t\t<td>Marc.Fisher@teradata.com</td>\n\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t<button role="button" class="btn btn-default">Edit</button>\n\t\t\t\t\t\t\t<button role="button" class="btn btn-warning">Block</button>\n\t\t\t\t\t\t\t<button role="button" class="btn btn-danger">Remove</button>\n\t\t\t\t\t\t</td>\n\t\t\t\t\t</tr>\n\t\t\t\t</tbody>\n\t\t\t</table>\n\t\t</div>\n\t</div>\n</div>\n\n\t<div style="display:none;">\n\t\t<p>Import</p>\n\t\tSupport from Nagios, CSV, others?\n\t\t<p>Manually add a system</p>\n\t\t<p>Add New User</p>\n\t\tSets ROLES\n\t\t<p>Remove User</p>\n\t\t<p>Create Group</p>\n\t\t<p>Add/Remove Users From Group</p>\n\t\t<p>Group Permissions</p>\n\t\tSystems they can see, ROLES, ...\n\t\t<p>Dashboard Availability?</p>\n\t\t<p>Widget Availability</p>\n\t\t<p>Polling Interval Per System</p>\n\t\t<p>Group Systems, a system can belong to n number of groups</p>\n\t\t<p>Other Features: Capacity Planning, Inventory, Data Center Layout, ...</p>\n\t\t<p>Auto Discovery: Port scan to find services running<p>\n\t\t</div>\n';
...
/*global define*/
define(
  'views/main/Admin',['marionette','vent','tpl!templates/main/admin.tmpl'],
...
define('tpl!templates/main/content.tmpl',[],function() { return function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="view dashboard-view">\n\t<div class="folders-wrapper">\n\t  <div id="folders">\n\t    <ul class="clearfix">\n\t    \t<li class="folder new" data-toggle="tooltip" data-title="Create a new dashboard">\n              <a href="#" data-action="new-folder"></a>\n            </li>\n\t    \t<li class="folder">\n\t\t    \t<a class="sys" data-id="ABC">\n\t\t    \t\t<h3 class="folder-name">ABC</h3>\n\t\t\t\t</a>\n\t\t\t\t<div class="bottom clearfix proxima-thin">\n\t\t\t\t  <div class="pull-left">\n\t\t\t\t    Last updated 3 days ago\n\t\t\t\t  </div>\n\t\t\t\t  <div class="btn-group dropdown pull-right">\n\t\t\t\t    <a class="btn dropdown-toggle" data-toggle="dropdown" href="#" style="background: transparent;border: transparent;">\n\t\t\t\t      <i class="fa fa-cog"></i>\n\t\t\t\t    </a>\n\t\t\t\t    <ul class="dropdown-menu">\n\t\t\t\t      <div class="dropdown-caret"></div>\n\t\t\t\t      <li data-id="ABC" class="export">\n\t\t\t\t      \t<a>\n\t\t\t\t      \t\t<i class="fa fa-download" style="margin-right: 5px;"></i> Export\n\t\t\t\t      \t</a>\n\t\t\t\t      </li>\n\t\t\t\t      <li data-id="ABC" class="export">\n\t\t\t\t      \t<a>\n\t\t\t\t      \t\t<i class="fa fa-share-square-o" style="margin-right: 5px;"></i> Share\n\t\t\t\t      \t</a>\n\t\t\t\t      </li>\n\t\t\t\t      <li class="divider"></li>\n\t\t\t\t      <li data-id="ABC" class="delete">\n\t\t\t\t      \t<a>\n\t\t\t\t      \t\t<div class="fa fa-times" style="margin-right: 5px;"></div> Delete\n\t\t\t\t      \t</a>\n\t\t\t\t      </li>\n\t\t\t\t    </ul>\n\t\t\t\t  </div>\n\t\t\t\t</div>\n\t\t\t</li>\n\t    </ul>\n\t  </div>\n\t</div>\n</div>';
...
/*global define*/
define(
  'views/main/Content',['marionette','vent','tpl!templates/main/content.tmpl'],
